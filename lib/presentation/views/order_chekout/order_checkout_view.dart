...
import 'package:karlagalvezapp/core/extension/string_extension.dart';
import 'package:karlagalvezapp/presentation/blocs/cart/cart_bloc.dart';
                            ...
                            if (state.deliveryInformation.isNotEmpty &&
                              ...
                              return Container(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      Text(
                                        "${state.selectedDeliveryInformation!.address}, ${state.selectedDeliveryInformation!.city}, ${state.selectedDeliveryInformation!.zipCode}",
                                    ...
                                    Flexible(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                              '\$${product.size.charge.toStringAsFixed(2)}')
                                        ],
                                      ),
                                    )
                                  ],
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                                "\$${items.fold(0.0, (previousValue, element) => (element.size.charge + previousValue))}")
                          ],
                        ),
                        const Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        ...
                        Row(
                          ...
                          children: [
                            const Text("Total"),
                            Text(
                                "\$${(items.fold(0.0, (previousValue, element) => (element.size.charge + previousValue)) + 4.99)}")
                          ],
                        )
                      ],
                    ),
