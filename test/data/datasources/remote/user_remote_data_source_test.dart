import 'dart:convert';
import 'package:karlagalvezapp/core/constant/strings.dart';
import 'package:karlagalvezapp/core/error/exceptions.dart';
import 'package:karlagalvezapp/core/error/failures.dart';
import 'package:karlagalvezapp/data/data_sources/remote/user_remote_data_source.dart';
...
void main() {
  ...
  group('signIn', () {
    test(
        ...
        () async {
      /// Arrange
      const fakeParams = SignInParams(email: 'username', password: 'password');
